...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="{{ asset('favi-icon.ico') }}" type="image/x-icon"/>
    ...
    <body class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <form class="form-inline my-2 my-lg-0" method="get">
                    <div class="input-group">
                        <input name="nomeCidade" class="form-control" type="search" placeholder="Cidade" aria-label="Nome da Cidade" style="border-right: none;">
        ...
        <div class="row">
            ...
            <div class="col-5 p-3 mb-2 bg-light">
                ...
                <thead>
                    <tr>
                        <th>Cidade <i class="fas fa-city"></i></th>
                        <th>Temp. <i class="fas fa-temperature-high"></i></th>
                        <th>Humidade <i class="fas fa-tint"></i></th>
                        <th>Previsão &nbsp &nbsp <i class="fas fa-cloud-sun"></i></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
